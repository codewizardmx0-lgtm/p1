          ...
          CommonCard(
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Row(
                    children: <Widget>[
                      Expanded(
                        child: Text(
                          "Summary", // استبدال AppLocalizations
                ...
                _getPhotoReviewUi("Room Photos", 'View All', Icons.arrow_forward,
                    () {}),

                HotelRoomeList(),
                _getPhotoReviewUi("Reviews", 'View All', Icons.arrow_forward,
                    () {
                ...
                Padding(
                  ...
                  child: CommonButton(
                    buttonText: "Book Now", // استبدال AppLocalizations
                    onTap: () {
    ...
    return Padding(
      ...
      child: Row(
        children: <Widget>[
          Expanded(
            child: Text(
              title, // نص ثابت بدل AppLocalizations
            ...
            child: InkWell(
              ...
              child: Padding(
                ...
                child: Row(
                  children: <Widget>[
                    Text(
                      view, // نص ثابت بدل AppLocalizations
