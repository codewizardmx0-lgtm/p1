          ...
          return AnimatedBuilder(
            ...
            builder: (BuildContext context, Widget? child) {
              return FadeTransition(
                ...
                child: Transform(
                  transform:
                      Matrix4.translationValues(50 * (1.0 - animation.value), 0.0, 0.0),
                  child: Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                          ...
                          children: <Widget>[
                            ...
                            Material(
                              ...
                              child: InkWell(
                                ...
                                child: Opacity(
                                  opacity:
                                      hotelTypeList[index].isSelected ? 1.0 : 0.0,
                                  child: CommonCard(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: Center(
                                        child: Icon(
                                          Icons.check, // أيقونة Flutter الأساسية
                        ...
                        Padding(
                          ...
                          child: Text(
                            hotelTypeList[index].titleTxt, // نص مباشر
                            maxLines: 2,
