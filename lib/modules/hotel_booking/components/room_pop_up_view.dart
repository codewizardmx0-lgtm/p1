...
class _RoomPopupViewState extends State<RoomPopupView>
  ...
  Widget build(BuildContext context) {
    final bool isLightMode = true; // يمكنك تعديلها حسب التصميم أو Theme
    return Center(
      child: Scaffold(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Text(
                            "الغرفة المحددة", // استبدل AppLocalizations
                        ...
                        Divider(height: 1),
                        getRowView("عدد الغرف", _roomData!.numberRoom, PopupTextType.no),
                        getRowView("عدد الأشخاص", _roomData!.people, PopupTextType.ad),
                        Padding(
                          padding: const EdgeInsets.only(
                              left: 16, right: 16, bottom: 16, top: 24),
                          child: CommonButton(
                            buttonText: "تطبيق", // استبدل AppLocalizations
                            onTap: () {
                              try {
                                widget.onChnage(_roomData!);
