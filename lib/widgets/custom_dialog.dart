              ...
              children: <Widget>[
                ...
                if (widget.actionButtonList != null &&
                  ...
                  widget.actionButtonList!.length > 2 || widget.isVerical
                      ? Column(children: getActionButtonsList(context))
                      : Row(children: getActionButtonsList(context))
                else
                  const SizedBox(),
              ],
            ),
    ...
    if (widget.actionButtonList != null) {
      if (widget.actionButtonList!.length > 2 || widget.isVerical) {
        ...
        return [
          ...
          Expanded(child: widget.actionButtonList![1]),
        ];
      } else {
        return [Expanded(child: widget.actionButtonList![0])];
      }
    } else {
      return <Widget>[];
    }
