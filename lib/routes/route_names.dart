...
import 'package:flutter_app/modules/Login/forgot_password.dart';
import 'package:flutter_app/modules/Login/login_screen.dart';
import 'package:flutter_app/modules/Login/sign_up_Screen.dart';
import 'package:flutter_app/routes/routes.dart';
import 'package:flutter_app/modules/bottom_tab/bottom_tab_screen.dart';
import '../models/hotel_list_data.dart';
import '../modules/Login/change_password.dart';
import '../modules/hotel_booking/hotel_home_screen.dart';
import '../modules/hotel_detailes/hotel_detailes.dart';
import '../modules/hotel_detailes/reviews_list_screen.dart';
import '../modules/hotel_detailes/search_screen.dart';
import '../modules/hotel_detailes/room_booking_screen.dart';
import '../modules/hotel_booking/filter_screen/filters_screen.dart';
import 'package:flutter_app/modules/profile/country_screen.dart';
import 'package:flutter_app/modules/profile/currency_screen.dart';
import 'package:flutter_app/modules/profile/edit_profile.dart';
import 'package:flutter_app/modules/profile/hepl_center_screen.dart';
import 'package:flutter_app/modules/profile/how_do_screen.dart';
import 'package:flutter_app/modules/profile/invite_screen.dart';
import 'package:flutter_app/modules/profile/settings_screen.dart';
...
class NavigationServices {
  ...
  Future<dynamic> gotoRoomBookingScreen(String hotelname) async {
    return await _pushMaterialPageRoute(RoomBookingScreen(hotelName: hotelname));
  }
